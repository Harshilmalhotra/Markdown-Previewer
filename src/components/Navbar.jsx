...
export default function Navbar() {
    return (
        ...
        <nav className="h-[4rem] flex justify-between bg-slate-950 p-3 border-b border-dashed border-gray-400">
            <div className="text-2xl sm:text-3xl font-mono font-bold bg-gradient-to-r from-rose-400 to-indigo-600 bg-clip-text text-transparent">Markdown Previewer</div>
